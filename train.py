...
#Now we iterate over all samples from the corpus and retrieve the word and the pre-labeled PoS tag (upostag). 
#This will be added as a list of tuples with a list of words and a list of their respective PoS tags.
ud_treebank = []
